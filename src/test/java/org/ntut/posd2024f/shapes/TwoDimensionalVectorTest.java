...
public class TwoDimensionalVectorTest {
    ...
    public void testTwoDimensionalVectorLength(){
        ...
        Assertions.assertEquals(3,twoDimensionalVector.length(),0.1);
    ...
    public void testTwoDimensionalVectorDot(){
        ...
        Assertions.assertEquals(0,twoDimensionalVector1.dot(twoDimensionalVector2));
    ...
    public void testTwoDimensionalVectorCross(){
        TwoDimensionalVector twoDimensionalVector1=new TwoDimensionalVector(0,3);
        TwoDimensionalVector twoDimensionalVector2=new TwoDimensionalVector(3,0);
        Assertions.assertEquals(-9,twoDimensionalVector1.cross(twoDimensionalVector2));
    ...
    public void testTwoDimensionalVectorSubtract(){
        ...
        Assertions.assertEquals(twoDimensionalVector3.getX(),twoDimensionalVector1.subtract(twoDimensionalVector2).getX());
        Assertions.assertEquals(twoDimensionalVector3.getY(),twoDimensionalVector1.subtract(twoDimensionalVector2).getY());
