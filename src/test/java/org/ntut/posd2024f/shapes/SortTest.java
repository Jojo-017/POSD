...
public class SortTest {
    ...
    public void testByAreaDescending() throws Exception {
        ...
        Assert.assertEquals(6, shapes.get(2).area(), 0.01);//Triangle
        Assert.assertEquals(12, shapes.get(1).area(), 0.01);//Rectangle
        Assert.assertEquals(12.56, shapes.get(0).area(), 0.01);//Circle
    }
    ...
    public void testByPerimeterAscending() throws Exception{
        ...
        Assert.assertEquals(14.0, shapes.get(2).perimeter(), 0.01); //Rectangle
        Assert.assertEquals(12.56, shapes.get(1).perimeter(), 0.01); //Circle
        Assert.assertEquals(12.0, shapes.get(0).perimeter(), 0.01); //Triangle
    }
